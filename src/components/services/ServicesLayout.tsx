...
const serviceItems = [
  { name: "Patrol", icon: "https://cdn.builder.io/api/v1/image/assets/b2b31d494c6f4b59a8b9179a4eb1a6ff/59c88dd37c820d10879865d0d03314afe3756f20?placeholderIfAbsent=true", path: "/services/patrol" },
