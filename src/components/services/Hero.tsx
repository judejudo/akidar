...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col relative min-h-[300px] w-full font-bold max-md:max-w-full ">
      ...
      /> */}
      <div className="relative bg-black/10 backdrop-blur-0  flex w-full flex-col items-stretch justify-center px-20 py-[33px] max-md:max-w-full max-md:px-5">
        <div className="self-center  bg-black/10 backdrop-blur-0  flex w-[734px] max-w-full items-stretch text-[50px] text-white text-center flex-wrap mt-10 max-md:text-[40px]">
